  ...
  const drawer = (
    <CommonStyles.Box>
      {miniDrawer ? (
        ...
        >
          <CommonStyles.Box sx={{ paddingTop: '2.25rem', marginBottom: '1.125rem' }}>
            <img
              src={`${IMG_URL}/uploads/2023/8/2/gotu-logo-14022515082023433135.png`}
              alt='Logo Got U'
              style={{ height: '100%' }}
            />
          </CommonStyles.Box>
          ...
          >
            {t('MerchantHomepage.forMerchant')}
          </CommonStyles.Typography>
        </CommonStyles.Toolbar>
      ) : null}
