      ...
      <Grid container rowSpacing={4} columnSpacing={{ xs: 2 }} sx={{ py: 2 }}>
        <Grid item xs={4} md={4}>
          <CommonStyles.Box sx={styles.contentItem}>
            <CommonStyles.Box sx={{ display: 'flex', gap: '10px' }}>
              ...
              >
                <CommonStyles.Typography variant='subtitle2' sx={styles.labelInput}>
                  {t('Articles.firstName')}
                </CommonStyles.Typography>
                <FastField
                  size='small'
                  component={CustomFields.TextField}
                  name='draft.firstName'
                  placeholder={t('Articles.yourFirstName')}
                  fullWidth
                  disabled
                />
              </CommonStyles.Box>
              ...
              >
                ...
                <FastField
                  ...
                  component={CustomFields.TextField}
                  name='draft.lastName'
                  placeholder={t('Articles.yourLastName')}
                  fullWidth
                  disabled
                />
              </CommonStyles.Box>
            ...
            >
              <CommonStyles.Typography variant='subtitle2' sx={styles.labelInput}>
                {t('Articles.citizenIdCard')}
              </CommonStyles.Typography>
              <FastField
                size='small'
                component={CustomFields.TextField}
                name='draft.cid'
                placeholder={t('Articles.idNumber')}
                fullWidth
                disabled
              />
            </CommonStyles.Box>
            ...
            >
              <CommonStyles.Typography variant='subtitle2' sx={styles.labelInput}>
                {t('Articles.residenceAccordingToPermanentAddress')}
              </CommonStyles.Typography>
              <FastField
                size='small'
                component={CustomFields.TextField}
                name='draft.residenceAccordingToPermanentAddress'
                placeholder={t('Articles.address')}
                fullWidth
                disabled
              />
            </CommonStyles.Box>
        ...
        <Grid item xs={4} md={4}>
          <CommonStyles.Box sx={styles.contentItem}>
            ...
            >
              <CommonStyles.Typography variant='subtitle2' sx={styles.labelInput}>
                {t('Articles.dateOfBirthAccordingToIdCard')}
              </CommonStyles.Typography>
              <FastField
                size='small'
                type='date'
        ...
        <Grid item xs={4} md={4}>
          <CommonStyles.Box sx={styles.contentItem}>
            ...
            >
              <CommonStyles.Typography variant='subtitle2' sx={styles.labelInput}>
                {t('Articles.localFriendLocation')}
              </CommonStyles.Typography>
    ...
    return (
      <CommonStyles.Box sx={{ mt: 2 }}>
        <CommonStyles.Typography sx={styles.title}>
          {t('Articles.emergencyContactInformation')}
        </CommonStyles.Typography>
        <Grid container rowSpacing={4} columnSpacing={{ xs: 2 }} sx={styles.gridContainer}>
          <Grid item xs={4} md={4}>
            ...
            >
              ...
              <FastField
                ...
                placeholder={t('Articles.firstLastName')}
                fullWidth
                disabled
              />
            </CommonStyles.Box>
          ...
          <Grid item xs={4} md={4}>
            ...
            >
              <CommonStyles.Typography variant='subtitle2' sx={styles.labelInput}>
                {t('Articles.relationship')}
              </CommonStyles.Typography>
              <FastField
                size='small'
                component={CustomFields.TextField}
                name='draft.relationship'
                placeholder={t('Articles.relationship')}
                fullWidth
                disabled
              />
            </CommonStyles.Box>
      ...
      <CommonStyles.Box sx={{ mt: 2 }}>
        ...
        <Grid container rowSpacing={4} columnSpacing={{ xs: 2 }} sx={styles.gridContainer}>
          ...
          <Grid item xs={8} md={8}>
            ...
            >
              <CommonStyles.Typography variant='subtitle2' sx={styles.labelInput}>
                {t('Articles.actualPortraitPhotoAtTheTimeOfRegistration')}
              </CommonStyles.Typography>
