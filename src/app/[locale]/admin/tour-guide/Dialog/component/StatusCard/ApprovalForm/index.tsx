  ...
  return (
    <CommonStyles.Box sx={{ width: 'inherit' }}>
      <CommonStyles.Box sx={{ display: 'flex', justifyContent: 'space-between', my: 2 }}>
        <CommonStyles.Typography variant='h6'>{t('LocalFriend.status')}</CommonStyles.Typography>
      ...
      <CommonStyles.Box sx={{ mt: 2 }}>
        <CommonStyles.Typography variant='h6'>{t('LocalFriend.confirm')}</CommonStyles.Typography>
      ...
      {isUpdate && (
        <CommonStyles.Box sx={{ mt: 2, width: 'inherit' }}>
          <CommonStyles.Typography variant='h6'>{t('LocalFriend.Review')}</CommonStyles.Typography>
