...
interface WaitingAcceptBookHeadingProps {}
...
const WaitingAcceptBookHeading = (props: WaitingAcceptBookHeadingProps) => {
  //! State
...
export default React.memo(WaitingAcceptBookHeading);
