...
const DealBooking = (props: DealBookingProps) => {
  ...
  const renderContentMarketing = () => {
    return (
      <CommonStylesClient.Box>
        ...
        >
          <CommonStylesClient.Box
            sx={{ width: '2rem', height: '0.125rem', background: theme.colors?.client.coBaltBlue }}
          />
        ...
        <CommonStylesClient.Typography type='pcHeading2' sx={{ fontSize: '2rem' }}>
  ...
  return (
    ...
    >
      ...
      <CommonStylesClient.Box
        sx={{ display: 'flex', flexDirection: 'column', rowGap: '2.5rem', paddingLeft: '2rem' }}
      >
